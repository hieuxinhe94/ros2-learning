...
class ObstacleAvoidanceNode(Node):
    def __init__(self):
        ...
        self.get_logger().info("[HIEUPV] CHẠY TRÁNH VẬT CẢN BẰNG DEPTH CAMERA ============================================")
        ...
        self.subscription_rgb = self.create_subscription(Image, '/depth_camera/color/image_raw', self.rgb_callback, 10)
        self.subscription_depth = self.create_subscription(Image, '/depth_camera/depth/image_raw', self.depth_callback, 10)
